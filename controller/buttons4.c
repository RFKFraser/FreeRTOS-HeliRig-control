...
initButtons (void)
{
	...
	// MODE switch (active HIGH)
    SysCtlPeripheralEnable (MODE_SW_PERIPH);
    GPIOPinTypeGPIOInput (MODE_SW_PORT_BASE, MODE_SW_PIN);
    GPIOPadConfigSet (MODE_SW_PORT_BASE, MODE_SW_PIN, GPIO_STRENGTH_2MA,
       GPIO_PIN_TYPE_STD_WPD);
    but_normal[MODE] = MODE_SW_NORMAL;
...
updateButtons (void)
{
	...
	but_value[MODE] = (GPIOPinRead (MODE_SW_PORT_BASE, MODE_SW_PIN) == MODE_SW_PIN);
