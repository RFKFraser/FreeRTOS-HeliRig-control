...
// Constants
//*****************************************************************************
enum butNames {MODE = 0, UP, DOWN, LEFT, RIGHT, NUM_BUTS};
enum butStates {RELEASED = 0, PUSHED, NO_CHANGE};
// Mode Switch
#define MODE_SW_PERIPH  SYSCTL_PERIPH_GPIOA
#define MODE_SW_PORT_BASE  GPIO_PORTA_BASE
#define MODE_SW_PIN  GPIO_PIN_7
#define MODE_SW_NORMAL  false
// UP button
